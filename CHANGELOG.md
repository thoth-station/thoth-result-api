...
* fixed a few typos
* I removed .s2i/ and incorporated the config in BC and DC, I also removed all namespace: declarations; both should make it easier to deploy via ansible/jenkins
* added .vscode/
